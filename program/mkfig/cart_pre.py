...
data_dir = "./data/cart/"
output_dir = "./fig/cart/pre_yz/"
output_dir2 = "./fig/cart/pre_zx/"
output_dir3 = "./fig/cart/pre_xy/"
...
def main():
	set_plt()
	data = np.fromfile(data_dir + settings["filepath_params"]["fname_pre"],dtype=np.float32) * 1e-2
