...
dy = triangle_size / ny
nr_vor = 250
vor_cx_float = triangle_size * 0.5
...
settings = {
  ...
  "filepath_params" : {
    ...
    "fpath_bs_pre" : f"{database_dir}sounding/sounding_gl9T28/bs_pres.dat",
    "fpath_bs_tem" : f"{database_dir}sounding/sounding_gl9T28/bs_tem.dat",
    "fpath_bs_qv" : f"{database_dir}sounding/sounding_gl9T28/bs_qv.dat",
    "fpath_u_profile" : "./data/wind_profile/bs_u.txt",
